...
contract LMPVaultRouterTest is BaseTest {
    ...
    function test_swapAndDepositToVaultViaMultiCall() public {
        ...
        uint256 vaultBalanceBefore = lmpVault.balanceOf(address(this));
        ...
        calls[2] = abi.encodeCall(lmpVaultRouter.depositBalance, (lmpVault, address(this), 0));

        lmpVaultRouter.multicall(calls);

        uint256 vaultBalanceAfter = lmpVault.balanceOf(address(this));
        ...
        assert(lmpVault.balanceOf(address(lmpVaultRouter)) == 0);
    }
